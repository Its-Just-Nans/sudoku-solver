...
void afficheurSudoku(uint16_t (*sudoku)[9][9], char *vSeparator, char *hSeparator);
void afficheurFullSudoku(uint16_t (*sudoku)[9][9], char *vSeparator, char *hSeparator);
...
void getColumn(uint16_t (*sudoku)[9][9], uint8_t nbColumn, uint8_t *buffer);
void getRow(uint16_t (*sudoku)[9][9], uint8_t nbRow, uint8_t *buffer);
void getSquare(uint16_t (*sudoku)[9][9], uint8_t nbSquare, uint8_t *buffer);
...
void setSmallNumberOfRow(uint16_t (*sudoku)[9][9], uint8_t numberOfRow, uint8_t *buffer);
void setSmallNumberOfSquare(uint16_t (*sudoku)[9][9], uint8_t numberOfRow, uint8_t *buffer);
