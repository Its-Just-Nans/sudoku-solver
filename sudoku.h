...
void afficheurFullSudoku(uint16_t (*sudoku)[9][9][1], char *vSeparator, char *hSeparator);
...
void setSmallNumberOfSquare(uint16_t (*sudoku)[9][9][1], uint8_t numberOfRow, uint8_t *buffer);
